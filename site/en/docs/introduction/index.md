...
[gateway](/en/docs/ingestion/index.md) lands and a row an [SDK](/en/docs/sdk/index.md) fetcher
...
| receive data over HTTP instead of fetching it | [Ingestion](/en/docs/ingestion/index.md) |
