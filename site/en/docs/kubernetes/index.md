...
> How to deploy the engine, with what permissions, and what to check afterwards.

*https://brevis.sh/en/docs/kubernetes/ · brevis.sh docs (en)*
...
- [Pod per step](/en/docs/pod-per-step/index.md) — the execution model
- [Configuration](/en/docs/configuration/index.md) — every `BREVIS_POD_*` variable
- [Observability](/en/docs/observability/index.md) — what to scrape, and from which process
