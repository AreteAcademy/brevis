...
> An HTTP endpoint that lands data — validate, identify, batch, deliver. Its own image, its own version.

*https://brevis.sh/en/docs/ingestion/ · brevis.sh docs (en)*
...
gateway lands and a row an [SDK](/en/docs/sdk/index.md) pipeline lands are *one row*,
...
| if you want | go to |
|---|---|
| the destinations and how each one writes | [Ingestion sinks](/en/docs/ingestion-sinks/index.md) |
| the `ingestion_id` from the other side | [Go SDK](/en/docs/sdk/index.md) |
| dashboards and alerts | [Observability](/en/docs/observability/index.md) |
