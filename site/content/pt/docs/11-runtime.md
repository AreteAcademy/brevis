---
title: Runtime do passo
description: O que o passo declara sobre a linguagem e as ferramentas que dirige — e por que quase nunca é preciso declarar.
group: Referência
order: 11
slug: runtime
---
...
- [Workflows](/docs/workflows/) — todos os campos do passo
- [Pod por passo](/docs/pod-per-step/) — onde o passo realmente executa
- [Observabilidade](/docs/observability/) — as métricas que acompanham
