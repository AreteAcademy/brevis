...
> Todas as variáveis de ambiente, com padrão, formato e o que acontece quando faltam.

*https://brevis.sh/docs/configuration/ · brevis.sh docs (pt-BR)*
...
| `BREVIS_METRICS_ADDR` | — | porta das métricas Prometheus; vazio = não expõe. Ver [Observabilidade](/docs/observability/index.md) |
