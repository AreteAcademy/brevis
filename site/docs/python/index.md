...
> pip install brevis — contexto entre passos, o relógio do run e métricas do seu pipeline, sem dependência nenhuma.

*https://brevis.sh/docs/python/ · brevis.sh docs (pt-BR)*
...
Sob [`for_each:`](/docs/workflows/index.md), o engine roda um processo por elemento e
...
- [Bibliotecas cliente](/docs/libraries/index.md) — o contrato e as outras linguagens
- [Contexto entre passos](/docs/context/index.md) — o conceito
- [Parâmetros](/docs/parameters/index.md) — os declarados
